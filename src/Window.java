...
public class Window extends JFrame {
	...
	public Window() {
		...
		crosshair_thickness_0
				.setIcon(new ImageIcon(Window.class.getResource("/crosshairImage/crosshair_thickness_0.png")));
		...
		crosshair_thickness_1
				.setIcon(new ImageIcon(Window.class.getResource("/crosshairImage/crosshair_thickness_1.png")));
		...
		getContentPane().add(lblDot);
		
		ItemListener itemListenerDot = new ItemListener() {
			public void itemStateChanged(ItemEvent itemEvent) {
				int state = itemEvent.getStateChange();
				if (state == ItemEvent.SELECTED) {
					lblDot.setIcon(new ImageIcon(Window.class.getResource("/crosshairImage/crosshair_dot_1.png")));
					d.setDot("cl_crosshairdot \"1\"");
					textArea.setText(d.getAlpha() + "\n" + d.getColor() + "\n" + d.getColor_b() + "\n" + d.getColor_r()
					+ "\n" + d.getColor_g() + "\n" + d.getDot() + "\n" + d.getGap() + "\n" + d.getSize() + "\n"
					+ d.getStyle() + "\n" + d.getUsealpha() + "\n" + d.getThickness() + "\n"
					+ d.getFixedcrosshairgap() + "\n" + d.getOutlinethickness() + "\n" + d.getDrawoutline());
				...
				JToggleButton btnToggleDot = new JToggleButton("");
				btnToggleDot.setBounds(250, 458, 65, 30);
				btnToggleDot.setContentAreaFilled(false);
				btnToggleDot.setBorderPainted(false);
				...
				lblProgrammHintergrund
						.setIcon(new ImageIcon(Window.class.getResource("/crosshairImage/programmBackground.png")));
		...
		JLabel lblDotBackground = new JLabel("");
		lblDotBackground.setIcon(new ImageIcon(Window.class.getResource("/crosshairImage/programmBackground.jpg")));
		lblDotBackground.setBounds(250, 455, 39, 36);
		getContentPane().add(lblDotBackground);
